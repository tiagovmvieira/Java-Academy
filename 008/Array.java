...
public class Array{
    ...
    public static void main(String[] args)
    {
         ...
         * An array size can't be changed once it is set
        ...
        // Cycles through all the boxes in the array and prints them
        ...
        for(int i = 0; i < multiDArray.length; i++)
        {
            ...
            {
                multiDArray[i][j] = i + " " + j; // We are concatenating int i,j with a " ",
                // so Java will automatically convert the integer values to strings, before performing the concatenation.
            }
        ...
        // Arrays.copyOf(arrayToCopy, numberToCopyFromBeggining);
        ...
        // Sort the array in aascending order
