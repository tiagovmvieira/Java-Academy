...
public class Lesson28 extends JFrame {
    ...
    public Lesson28(){
        ...
        // We can also define the pixels that separate the components
        ...
        // If we put components in the same space the
        // last oe in stays and everything else goes
        // EX.
        ...
        */
        ...
        /* If we want more than one component to show
        ...
        */
        ...
        // We can also use Box theBox = Box.createVerticalBox();
        ...
        // We can also separate the components with struts
        /*
        theBox.add(button1);
