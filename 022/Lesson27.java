...
// Enumerations are used to store the related items together
...
public class Lesson27 extends JFrame{
    ...
    // The nodes inside a parent node are children nodes
    ...
    public Lesson27(){
        ...
        // By default tou can make multiple selections
        theTree.getSelectionModel().setSelectionMode(TreeSelectionModel.SINGLE_TREE_SELECTION);

        // Only show 8 ros of the tree at a time
    ...
    private class ListenForButton implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource() == button1){
                ...
                // getPat returns an array of TreeNodes
