...
public class Lesson22 extends JFrame
{
    ...
    public Lesson22(){
        ...
        // The JPanel contains all the components for our frame
        ...
        // We do this so that when 1 is selected the others
        // are deselected
        ...
        // Create a new panel to hod radio buttons
        JPanel operPanel = new JPanel();

        // Surround radio button panel with a border
        // We can define different types of borders
    ...
    private double addNumbers(double theNum1, double theNum2, int howManyTimes) {
    ...
    private double subtractNumbers(double theNum1, double theNum2, int howManyTimes){
    ...
    private double multNumbers(double theNum1, double theNum2, int howManyTimes){
    ...
    private double divideNumbers(double theNum1, double theNum2, int howManyTimes){
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource() == button1){
                ...
                try{
                    ...
                    JOptionPane.showMessageDialog(Lesson22.this, "Please Enter the Right Info",
                ...
                if(dollarSign.isSelected()){
                    // Defines that we want to format a number with $ and commas
                    ...
                    // Defines that we want to format a number with commas
    ...
    private class ListenForSlider implements ChangeListener{
        ...
        public void stateChanged(ChangeEvent e) {
            ...
            System.out.println("Hello World from the ListenForSlider");
        }
    }
