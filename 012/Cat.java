...
// You create subclasses with the extend keyword
...
public class Cat extends Animal
{
    ...
    // Here we overrode the Animal walkAround method
    public void walkAround(){

        // this refers to a specific object created of type Cat
        System.out.println(this.getName() + " walks aournd and then sleeps");
