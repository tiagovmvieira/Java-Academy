...
// Object that allows us to use height & width units
import java.awt.Dimension;

// Used to get today's date to use with Calendar
...
public class Lesson26 extends JFrame
{
    ...
    public Lesson26(){
        ...
        JSpinner.DateEditor dateEditor = new JSpinner.DateEditor(spinner4,
                "dd/MM/yyyy");
