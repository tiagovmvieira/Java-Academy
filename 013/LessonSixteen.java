public class LessonSixteen {
    ...
    public static void main(String[] args){
        ...
        // superCar inherits all the Object methods, but an object
        // of class Object can't access the Vehicle methods

        // System.out.println(superCar.getSpeed()); * Throws an error

        // We can cast from type Object to Vehicle to access those methods
        ...
        // is no longer of use. If we call it there is no guarantee it will
        // do anything though
        ...
        // THE CLASS OBJECT
        // We can use the Class object method getName to get just the class name

        System.out.println(superCar.getClass().getName());

        // We can check if 2 objects are of the same class with getClass
        ...
        System.out.println("Number of WheelS: " + superTruck.getWheels());
        System.out.println("Number of WheelS: " + superTruck2.getWheels());
