...
public class Strings
{
    public static void main(String[] args){
        ...
        // charAt returns the character in a string at a specified index
        ...
        // contains() returns a boolean depending on wheter the
        ...
        // the second String we provide
        System.out.println(letters.replace("abc", "xy"));

        // We can create an array of Strings with split()
        // We define how to break up the String use a delimiter
        // If we had 123,456 and used the delimiter "," we would
        ...
        // toUpperCase() convert all letters into uppercase
